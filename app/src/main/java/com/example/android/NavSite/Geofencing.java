...
public class Geofencing implements ResultCallback {
     ...
     *given a place buffer instance, it goes all the places in it, and for each place, it will create a geofence object and add it to a list
     *
    ...
    private GeofencingRequest getGeofencingRequest() {
        ...
        // this trigger defines what happens in case the device was already inside any of the geofences tha we are about to register
        // and in this case, it means that if the device is already  inside then triger and entry transition event immedialtly

        builder.setInitialTrigger(GeofencingRequest.INITIAL_TRIGGER_ENTER);
        // now we add the geofences to the array list we created
        builder.addGeofences(mGeofenceList);
        // and build it, then return it
    ...
    private PendingIntent getGeofencePendingIntent() {
        ...
        // create intent for geofences broadcast receiver
        Intent intent = new Intent(mContext, GeofenceBroadcastReceiver.class);
        // then the method pending.getbroadcast is used to create the pending intent
        // we can also cache this pending intent to reuse it every time rather than creating new one
