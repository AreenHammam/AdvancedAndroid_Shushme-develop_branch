package com.example.android.NavSite.provider;
...
import com.example.android.NavSite.provider.PlaceContract.PlaceEntry;

public class PlaceDbHelper extends SQLiteOpenHelper {

    // The database name
    private static final String DATABASE_NAME = "NavSite.db";
